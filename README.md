...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-j7v9u7s.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-j7v9u7s.containers.anotherwebservice.com/
...
```
git clone git@github.com:Jw8290077/container-j7v9u7s.git
cd container-j7v9u7s
```
...
```
docker attach container-j7v9u7s
```
